 ...
 *
 */
class FavorListFragment : Fragment(){
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val frags = arrayOf<Fragment>(DayTypeMealFragment.newInstance("today", "BR", true, mcontext),
                DayTypeMealFragment.newInstance("today", "LU", true, mcontext),
                DayTypeMealFragment.newInstance("today", "DN", true, mcontext),
                DayTypeMealFragment.newInstance("tomorrow", "BR", true, mcontext),
                DayTypeMealFragment.newInstance("tomorrow", "LU", true, mcontext),
                DayTypeMealFragment.newInstance("tomorrow", "DN", true, mcontext))
